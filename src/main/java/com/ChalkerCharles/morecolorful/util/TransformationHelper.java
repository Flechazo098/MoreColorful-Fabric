 ...
 *
 * This class provides helper methods for constructing and interpolating 3D transformations,
 * including quaternion creation from Euler angles or raw components, linear and spherical
 * interpolation of vectors and quaternions, and JSON deserialization of Minecraft model
...
public final class TransformationHelper {
    ...
    public static class Deserializer implements JsonDeserializer<Transformation> {
        ...
        public Transformation deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) throws JsonParseException {
            ...
            TransformationExtensions ext = (TransformationExtensions) (Object) matrix;
            return ext.applyOrigin(new Vector3f(origin));
